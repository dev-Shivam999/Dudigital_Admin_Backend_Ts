...
import { getCategories, getReportsByCategory, createReport, deleteReport } from '../services/api';
...
const InvestorRelations = () => {
    ...
    return (
        <div style={{ display: 'flex', gap: '2rem', padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ flex: '1', minWidth: '250px', borderRight: '1px solid #eee', paddingRight: '1rem' }}>
                <h2>Categories</h2>
                    ...
                    {categories.map(cat => (
                        <div 
                            ...
                            style={{
                                ...
                                borderRadius: '4px',
                                cursor: 'pointer',
                                background: selectedCategory?._id === cat._id ? '#e6f0ff' : 'transparent',
                                display: 'flex',
                                alignItems: 'center',
                                gap: '10px'
                            }}
            ...
            <div style={{ flex: '3' }}>
                {selectedCategory ? (
                    <>
                        <h1 style={{ marginBottom: '20px' }}>{selectedCategory.name} Reports</h1>
                                    ...
                                    <div key={report._id} style={{ 
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                            ...
                                            <div>
                                                ...
                                                <div style={{ fontSize: '0.9rem', color: '#666' }}>{report.financialYear} • {new Date(report.uploadedDate).toLocaleDateString()}</div>
                                            </div>
                                        </div>
